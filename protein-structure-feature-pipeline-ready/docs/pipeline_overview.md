...
3. **Local track calculation**: compute secondary structure, RSA/buried residues, hydropathy, approximate clashes, bond outliers, and cis-peptide flags.
4. **Disorder and Q-score integration**: run or parse optional external features and map residue-level values back to chain coordinates.
