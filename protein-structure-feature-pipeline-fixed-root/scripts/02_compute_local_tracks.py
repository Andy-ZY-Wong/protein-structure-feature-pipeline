...
2. Buried residues / RSA: FreeSASA
3. Hydropathy: Kyte-Doolittle
4. Atomic clashes: internal approximate VDW-overlap algorithm
5. Bond outliers: internal approximate backbone bond-length outlier algorithm
6. Cis-peptide: omega dihedral calculation

Disorder and Q-score features are intentionally handled by
03_compute_disorder_qscore.py to keep Stage 02 focused on local
...
- Disorder and Q-score are not computed in this script; they are handled later by 03_compute_disorder_qscore.py and written back to JSON.
...
# ============================================================
# 4. Atomic clashes: approximate VDW overlap
# ============================================================
...
# ============================================================
# 6. Cis-peptide: omega dihedral angle
# ============================================================
